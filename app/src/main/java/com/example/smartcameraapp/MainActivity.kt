        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            labeler.process(imageForMLKit)
                .addOnSuccessListener { labels ->
                    Log.i("Kamal", "Successfully processed image")
                    ...
                    for (label in labels) {
                        ...
                        Log.i("Kamal", "LOOP > [$text]:$confidence")
                        Log.i("Kamal", "detected: " + text + "with confidence: " + confidence)                    }
                }
                .addOnFailureListener { e ->
                    Log.e("Kamal", "Error processed image")
